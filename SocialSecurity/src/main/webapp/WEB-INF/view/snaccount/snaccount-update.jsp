   ...
   <body>
        ...
        <div class='add_attr_form panel panel-default'>
            <div class="panel panel-heading">
                Update facebook login account
            </div>
            <div class="panel panel-body">

                    
                <form:form class="form-horizontal input_fields_wrap" method="post" modelAttribute="account" action="${pageContext.request.contextPath}/snaccount/update">
                    <form:hidden path="id"/>
                    <label>Login:</label>
                    ...
                    <button style='margin: 10px'class='btn btn-info' type='submit'>Update</button>
                </form:form>
            </div>
